  ...
  return (
    <>
      ...
      <Dialog open={isAccountOpen} onOpenChange={(open) => !open && closeAccount()}>
        <DialogContent className="w-[92vw] sm:max-w-[400px] rounded-[2rem] sm:rounded-3xl p-6 bg-cream border-2 border-yellow/30 max-h-[85vh] overflow-y-auto z-[60]">
          ...
          <div className="space-y-5 mt-2">
            ...
            <div className="bg-white rounded-3xl p-5 border border-purple/10 shadow-sm text-center">
              ...
              <h3 className="font-display text-lg text-purple font-semibold text-center">
                {profileName}
              </h3>
              <p className="text-xs text-muted-foreground text-center">Member since May 2026</p>
      ...
      {isTrackOpen && (
        <Dialog open={isTrackOpen} onOpenChange={(open) => {
          ...
          <DialogContent className="w-[92vw] sm:max-w-[480px] rounded-[2rem] sm:rounded-3xl p-6 sm:p-8 bg-white border-2 border-yellow/20 shadow-xl max-h-[85vh] overflow-y-auto z-[60]">
            <DialogHeader className="pb-2">
      ...
      {isSettingsOpen && (
        <Dialog open={isSettingsOpen} onOpenChange={(open) => !open && setIsSettingsOpen(false)}>
          <DialogContent className="w-[92vw] sm:max-w-[400px] rounded-[2rem] sm:rounded-3xl p-6 bg-cream border-2 border-yellow/30 max-h-[85vh] overflow-y-auto z-[60]">
            <DialogHeader className="pb-2">
              <DialogTitle className="font-display text-2xl text-purple text-center">
                ⚙️ Profile Settings
